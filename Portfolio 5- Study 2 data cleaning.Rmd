...
First, "session" was computed manually by dropping the A, B, C, D, from participant_id. 
From that, "condition" was created by comparing to a separate document that tracked the sessions and conditions.

On condition, 0=control, 1=talk, 2=experimental.


From there I created a variable called section, which used the separate document to track the session they were in, i.e, what class.
